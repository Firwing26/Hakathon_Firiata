...
$app->post('/', function() use($app) {
      ...
      switch ( $data->type )
      {
        ...
        case 'message_new':
             ...
             if ($slovo == 'привет')  {
                $request_params['message'] = 'Приветствую на пути просвещения. Я готов помочь в трудную минуту непониания детей и родителе подсказав что могло стать причиной, как этого избежать и как это исправить. Я помогу поддержав добрым словом.' "/n"  ' я знаю такие ключевые слова: курит, сбегает' ;
 }
