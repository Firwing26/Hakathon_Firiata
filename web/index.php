...
$app->post('/', function() use($app) {
      ...
      switch ( $data->type )
      {
        ...
        case 'message_new':
             ...
             if ($slovo == $problem['sekond'] and $slovo == $problem['first']  ) {
                 ...
                 либо ребенок испытывает серьезные душевные терзания которыми могут являться как его личная жизнь и самокопания так и вы';
}
